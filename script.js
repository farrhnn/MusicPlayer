    ...
    lyrics: [
    ...
    },
      {
        ...
        lyrics: [
          ...
          {time: 129, text: "And pretend (Don't let go)"},
          ...
          {time: 184, text: "There was something about you that now I can't remember "},
          {time: 189, text: "It's the same damn thing that made my heart surrender"},
          {time: 194, text: "And I'll miss you on a train"},
          {time: 197, text: "I'll miss you in the morning"},
          {time: 199, text: "I never know what to think about"},
          {time: 203, text: " I think about you  (So don't letgo)"},
